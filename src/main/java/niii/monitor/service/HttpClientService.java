...
public class HttpClientService {
    ...
    public String post(final String url, final BaseData data) {
        try {
    ...
    public String put(final String url, final BaseData data) {
        try {
    ...
    public String patch(final String url, final BaseData data) {
